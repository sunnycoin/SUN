...
Unit tests are bundled in the `sunnycoind` executable and can be executed using the
...
must specify it by suite or full-name (e.g. `sunnycoin.app.NoSUNNYCoinCheckLimits` or
just `NoSUNNYCoinCheckLimits`).
