...
/*
    ...
    Copyright 2015 SUNNYCoin Labs Inc.
...
#include <sunnycoin/overlay/ClusterNode.h>
#include <sunnycoin/protocol/SecretKey.h>

namespace sunnycoin {
namespace tests {

class cluster_test : public sunnycoin::TestSuite
{
public:
...
BEAST_DEFINE_TESTSUITE(cluster,overlay,sunnycoin);
