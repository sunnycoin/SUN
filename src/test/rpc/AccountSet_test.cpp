...
public:
    ...
    void testNullAccountSet()
    {
        ...
        env.fund(SUN(10000), nosunnycoin(alice));
    ...
    void testMostFlags()
    {
        ...
        testFlags ({asfRequireDest, asfRequireAuth, asfDisallowSUN,
            asfGlobalFreeze, asfDisableMaster, asfDefaultSUNNYCoin});
    ...
    void testBadInputs(bool withFeatures)
    {
        ...
        auto jt = fset(alice, asfDisallowSUN);
        jt[jss::ClearFlag] = asfDisallowSUN;
        ...
        jt = fset(alice, asfDisallowSUN);
        jt[sfFlags.fieldName] = tfAllowSUN;
        env(jt, ter(temINVALID_FLAG));
...
BEAST_DEFINE_TESTSUITE(AccountSet,app,sunnycoin);
