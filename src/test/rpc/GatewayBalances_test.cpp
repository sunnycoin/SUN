...
public:
    ...
    testGWB(FeatureBitset features)
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            expect(jv.isMember(jss::sunnycoinrpc) && jv[jss::sunnycoinrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(GatewayBalances,app,sunnycoin);
