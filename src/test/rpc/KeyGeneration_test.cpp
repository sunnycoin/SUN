...
#include <sunnycoin/rpc/handlers/WalletPropose.h>
...
class WalletPropose_test : public sunnycoin::TestSuite
{
public:
...
BEAST_DEFINE_TESTSUITE(WalletPropose,sunnycoin_basics,sunnycoin);
