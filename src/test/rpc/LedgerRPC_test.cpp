...
/*
    ...
    Copyright (c) 2012-2016 SUNNYCoin Labs Inc.
...
class LedgerRPC_test : public beast::unit_test::suite
{
    ...
    // '!' is not part of the sunnycoin alphabet.
    std::string
    ...
    void testLedgerEntryCheck()
    {
        ...
        env (checkCreate (env.master, alice, SUN(100)));
        env.close();
    ...
    void testLedgerEntryEscrow()
    {
        ...
        env (escrowCreate (alice, alice, SUN(333), env.now() + 2s));
        env.close();
        ...
        std::string escrowIndex;
        {
            ...
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
                jrr[jss::node][jss::Amount] == SUN(333).value().getText());
    ...
    void testLedgerEntryOffer()
    {
        ...
        env (offer (alice, USD (321), SUN (322)));
        env.close();
    ...
    void testLedgerEntryPayChan()
    {
        ...
        env (payChanCreate (alice, env.master, SUN(57), 18s, alice.pk()));
        env.close();
    ...
    void testLedgerEntrySUNNYCoinState()
    {
        testcase ("ledger_entry Request SUNNYCoinState");
        using namespace test::jtx;
        Env env {*this};
        Account const alice {"alice"};
        Account const gw { "gateway" };
        ...
        std::string const ledgerHash {to_string (env.closed()->info().hash)};
        {
            ...
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
        ...
        {
            // sunnycoin_state is not an object.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = "sunnycoin_state";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            checkErrorValue (jrr, "malformedRequest", "");
        ...
        {
            // sunnycoin_state.currency is missing.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
        ...
        {
            // sunnycoin_state accounts is not an array.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = 2;
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // sunnycoin_state one of the accounts is missing.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
        ...
        {
            // sunnycoin_state more than 2 accounts.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::sunnycoin_state][jss::accounts][2u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // sunnycoin_state account[0] is not a string.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = 44;
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
        ...
        {
            // sunnycoin_state account[1] is not a string.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = 21;
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // sunnycoin_state account[0] == account[1].
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // sunnycoin_state malformed account[0].
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] =
        ...
        {
            // sunnycoin_state malformed account[1].
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] =
        ...
        {
            // sunnycoin_state malformed currency.
            Json::Value jvParams;
            jvParams[jss::sunnycoin_state] = Json::objectValue;
            jvParams[jss::sunnycoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::sunnycoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::sunnycoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::sunnycoin_state][jss::currency] = "USDollars";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
    ...
    void testLookupLedger()
    {
        ...
        env.fund(SUN(10000), "alice");
        env.close();
        env.fund(SUN(10000), "bob");
        env.close();
        env.fund(SUN(10000), "jim");
        env.close();
        env.fund(SUN(10000), "jill");
    ...
    void testQueue()
    {
        ...
        env.fund(SUN(10000), bob);
        env.close();
        env.fund(SUN(10000), charlie);
        env.fund(SUN(10000), daria);
        env.close();
        ...
        env(pay(alice, "george", SUN(1000)), json(R"({"LastLedgerSequence":7})"),
            ter(terQUEUED));
        env(offer(alice, SUN(50000), alice["USD"](5000)), seq(aliceSeq + 1),
            ter(terQUEUED));
...
BEAST_DEFINE_TESTSUITE(LedgerRPC,app,sunnycoin);
