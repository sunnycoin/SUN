   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::sunnycoinrpc) && info[jss::sunnycoinrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::sunnycoinrpc) && info[0u][jss::sunnycoinrpc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::sunnycoinrpc) && info[1u][jss::sunnycoinrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountInfo,app,sunnycoin);
