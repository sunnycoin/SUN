...
public:
    void testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoSUNNYCoin | tfSetFreeze));
        }
        env.close();
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_sunnycoin].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_sunnycoin_peer].asBool() == true);
    ...
    void testAccountLineDelete()
    {
        ...
        //   o alice offers to buy 100 USD for 100 SUN.
        //   o becky offers to sell 100 USD for 100 SUN.
        ...
        Account const gw1 {"gw1"};
        Account const gw2 {"gw2"};
        env.fund(SUN(10000), alice, becky, cheri, gw1, gw2);
        env.close();
        ...
        // alice offers to buy 100 EUR for 100 SUN.
        env(offer(alice, EUR(100), SUN(100)));
        env.close();

        // becky offers to buy 100 SUN for 100 EUR.
        env(offer(becky, SUN(100), EUR(100)));
        env.close();
    ...
    void testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            BEAST_EXPECT(lines.isMember(jss::sunnycoinrpc) && lines[jss::sunnycoinrpc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc ("json2", "{ "
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::sunnycoinrpc) && linesSeq[jss::sunnycoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::sunnycoinrpc) && linesHash[jss::sunnycoinrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::sunnycoinrpc) && linesA[jss::sunnycoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::sunnycoinrpc) && linesB[jss::sunnycoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::sunnycoinrpc) && linesC[jss::sunnycoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesD.isMember(jss::sunnycoinrpc) && linesD[jss::sunnycoinrpc] == "2.0");
    ...
    void testAccountLineDelete2()
    {
        ...
        //   o alice offers to buy 100 EUR for 100 SUN.
        //   o becky offers to sell 100 EUR for 100 SUN.
        ...
        BEAST_EXPECT(linesBeg.isMember(jss::sunnycoinrpc) && linesBeg[jss::sunnycoinrpc] == "2.0");
        ...
        BEAST_EXPECT(linesEnd.isMember(jss::sunnycoinrpc) && linesEnd[jss::sunnycoinrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountLinesRPC,app,sunnycoin);
