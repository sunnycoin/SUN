...
{ "Cannot create SUN to SUN paths.",
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
{ "Even though 'Amount' may not be SUN for pathfinding, 'SendMax' may be SUN.",
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
public:
    ...
    void testTransactionRPC ()
    {
        ...
        test::jtx::Env env(*this);
        env.fund(test::jtx::SUN(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC,sunnycoin_app,sunnycoin);
