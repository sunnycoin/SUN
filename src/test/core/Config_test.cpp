...
{
    static boost::format configContentsTemplate (R"sunnycoinConfig(
[server]
port_rpc
port_peer
port_wss_admin
...
[node_db]
type=memory
path=/Users/dummy/sunnycoin/config/db/rocksdb
open_files=2000
filter_bits=12
cache_mb=256
file_size_mb=8
...
[debug_logfile]
/Users/dummy/sunnycoin/config/log/debug.log
...
/**
   Write a sunnycoind config file and remove when done.
 */
class SUNNYCoindCfgGuard : public ConfigGuard
{
private:
    path configFile_;
    path dataDir_;
...
public:
    SUNNYCoindCfgGuard (beast::unit_test::suite& test,
    ...
    ~SUNNYCoindCfgGuard ()
    {
        ...
        {
            // if we throw here, just let it die.
            test_.log << "Error in ~SUNNYCoindCfgGuard: "
                      << e.what () << std::endl;
        };
    }
};
...
{
    std::string configContents (R"sunnycoinConfig(
[validators]
...
recommendedsunnycoinvalidators.com
moresunnycoinvalidators.net
...
public:
    void testLegacy ()
    {
        ...
        std::string toLoad(R"sunnycoinConfig(
[server]
port_rpc
port_peer
port_wss_admin
...
masterpassphrase
    ...
    void testDbPath ()
    {
        ...
        }
        {
            ...
            detail::SUNNYCoindCfgGuard const g (*this, g0.subdir(),
                dataDirAbs, "", false);
        ...
        }
        {
            ...
            detail::SUNNYCoindCfgGuard const g (*this, "test_db", dbPath, "");
            auto const& c (g.config ());
        ...
        }
        {
            ...
            detail::SUNNYCoindCfgGuard const g (*this, "test_db", "", "");
            auto const& c (g.config ());
    ...
    void testValidatorKeys ()
    {
        ...
        {
            Config c;
            static boost::format configTemplate (R"sunnycoinConfig(
[validation_seed]
%1%
...
trustthesevalidators.gov
        ...
        }
        {
            ...
            detail::SUNNYCoindCfgGuard const rcg (
        ...
        }
        {
            ...
            detail::ValidatorsTxtGuard const vtg (
                *this, "test_cfg", "validators.txt");
            detail::SUNNYCoindCfgGuard const rcg (*this, vtg.subdir (),
                "", "", false);
            BEAST_EXPECT(vtg.validatorsFileExists ());
            BEAST_EXPECT(rcg.configFileExists ());
            auto const& c (rcg.config ());
...

        {
            ...
            boost::format cc (R"sunnycoinConfig(
[validators_file]
%1%
...
021A99A537FDEBC34E4FCA03B39BEADD04299BB19E85097EC92B15A3518801E566
        ...
        }
        {
            ...
            // [validator_list_keys] are missing from sunnycoind cfg and
            // validators file
            Config c;
            boost::format cc ("[validators_file]\n%1%\n");
            std::string error;
    ...
    {
        detail::SUNNYCoindCfgGuard const cfg(*this, "testSetup",
    ...
    void testPort ()
    {
        detail::SUNNYCoindCfgGuard const cfg(*this, "testPort", "", "");
...
BEAST_DEFINE_TESTSUITE (Config, core, sunnycoin);
