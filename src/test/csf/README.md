...
controlled manner. It is also used to unit test the generic SUNNYCoin consensus
...
completely abstracted from the details of the SUN ledger and transactions. In
