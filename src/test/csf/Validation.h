...
*/
//==============================================================================
#ifndef SUNNYCOIN_TEST_CSF_VALIDATION_H_INCLUDED
#define SUNNYCOIN_TEST_CSF_VALIDATION_H_INCLUDED
...
public:
    ...
    unwrap() const
    {
        // For the sunnycoind implementation in which RCLValidation wraps
