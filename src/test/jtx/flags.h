...
#ifndef SUNNYCOIN_TEST_JTX_FLAGS_H_INCLUDED
#define SUNNYCOIN_TEST_JTX_FLAGS_H_INCLUDED
...
private:
    ...
    set_args (std::uint32_t flag)
    {
        ...
        case asfDisallowSUN:    mask_ |= lsfDisallowSUN;    break;
        ...
        case asfDefaultSUNNYCoin:  mask_ |= lsfDefaultSUNNYCoin;  break;
