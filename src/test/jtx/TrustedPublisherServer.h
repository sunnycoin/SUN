...
/*
    ...
    Copyright 2017 SUNNYCoin Labs Inc.
...
*/
//==============================================================================
#ifndef SUNNYCOIN_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
#define SUNNYCOIN_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
...
public:
        ...
        : sock_(ios), acceptor_(ios)
    {
        endpoint_type const& ep {
            beast::IP::Address::from_string (sunnycoin::test::getEnvLocalhostAddr()),
