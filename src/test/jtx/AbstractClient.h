...
#ifndef SUNNYCOIN_TEST_ABSTRACTCLIENT_H_INCLUDED
#define SUNNYCOIN_TEST_ABSTRACTCLIENT_H_INCLUDED
...
/* Abstract SUNNYCoin Client interface.

   This abstracts the transport layer, allowing
   commands to be submitted to a sunnycoind server.
*/
