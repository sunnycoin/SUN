...
#ifndef SUNNYCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
#define SUNNYCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
...
/// sunnycoin::Config. The function takes ownership of the unique_ptr and
