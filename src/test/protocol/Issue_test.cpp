...
#ifndef SUNNYCOIN_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define SUNNYCOIN_ASSETS_ENABLE_STD_HASH 0
# else
#  define SUNNYCOIN_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if SUNNYCOIN_ASSETS_ENABLE_STD_HASH
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,sunnycoin);
