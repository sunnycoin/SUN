...
#include <sunnycoin/protocol/InnerObjectFormats.h>
#include <sunnycoin/protocol/ErrorCodes.h>          // RPC::containsError
#include <sunnycoin/json/json_reader.h>             // Json::Reader
#include <sunnycoin/protocol/STParsedJSON.h>        // STParsedJSONObject
...
BEAST_DEFINE_TESTSUITE(InnerObjectFormatsParsedJSON,sunnycoin_app,sunnycoin);
