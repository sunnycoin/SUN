...
#ifndef SUNNYCOIN_SERVER_BASEHTTPPEER_H_INCLUDED
#define SUNNYCOIN_SERVER_BASEHTTPPEER_H_INCLUDED
...
#include <sunnycoin/beast/asio/ssl_error.h> // for is_short_read?
