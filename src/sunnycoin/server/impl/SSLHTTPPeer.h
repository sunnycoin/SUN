...
#ifndef SUNNYCOIN_SERVER_SSLHTTPPEER_H_INCLUDED
#define SUNNYCOIN_SERVER_SSLHTTPPEER_H_INCLUDED

#include <sunnycoin/server/impl/BaseHTTPPeer.h>
#include <sunnycoin/server/impl/SSLWSPeer.h>
