...
#ifndef SUNNYCOIN_SERVER_SERVERIMPL_H_INCLUDED
#define SUNNYCOIN_SERVER_SERVERIMPL_H_INCLUDED

#include <sunnycoin/basics/chrono.h>
#include <sunnycoin/server/Server.h>
#include <sunnycoin/server/impl/Door.h>
#include <sunnycoin/server/impl/io_list.h>
