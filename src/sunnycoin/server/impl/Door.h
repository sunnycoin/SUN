...
#ifndef SUNNYCOIN_SERVER_DOOR_H_INCLUDED
#define SUNNYCOIN_SERVER_DOOR_H_INCLUDED

#include <sunnycoin/server/impl/io_list.h>
#include <sunnycoin/basics/contract.h>
#include <sunnycoin/basics/Log.h>
#include <sunnycoin/server/impl/PlainHTTPPeer.h>
#include <sunnycoin/server/impl/SSLHTTPPeer.h>
#include <sunnycoin/beast/asio/ssl_bundle.h>
