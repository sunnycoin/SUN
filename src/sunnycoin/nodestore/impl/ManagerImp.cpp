...
#include <sunnycoin/nodestore/impl/ManagerImp.h>
#include <sunnycoin/nodestore/impl/DatabaseNodeImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your sunnycoind.cfg is missing a [node_db] entry, "
        "please see the sunnycoind-example.cfg file!"
        );
}
