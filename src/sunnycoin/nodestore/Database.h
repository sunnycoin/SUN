...
#ifndef SUNNYCOIN_NODESTORE_DATABASE_H_INCLUDED
#define SUNNYCOIN_NODESTORE_DATABASE_H_INCLUDED

#include <sunnycoin/basics/TaggedCache.h>
#include <sunnycoin/basics/KeyCache.h>
#include <sunnycoin/core/Stoppable.h>
#include <sunnycoin/nodestore/Backend.h>
#include <sunnycoin/nodestore/impl/Tuning.h>
#include <sunnycoin/nodestore/Scheduler.h>
...
private:
    ...
    // The default is 32570 to match the SUN ledger network's earliest
    // allowed sequence. Alternate networks may set this value.
    std::uint32_t earliestSeq_ {SUN_LEDGER_EARLIEST_SEQ};
