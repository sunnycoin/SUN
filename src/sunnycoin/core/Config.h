...
#ifndef SUNNYCOIN_CORE_CONFIG_H_INCLUDED
#define SUNNYCOIN_CORE_CONFIG_H_INCLUDED

#include <sunnycoin/basics/BasicConfig.h>
#include <sunnycoin/basics/base_uint.h>
#include <sunnycoin/protocol/SystemParameters.h> // VFALCO Breaks levelization
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from sunnycoind.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from sunnycoind.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from sunnycoind.cfg.
