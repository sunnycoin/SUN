...
#ifndef SUNNYCOIN_PROTOCOL_ACCOUNTID_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_ACCOUNTID_H_INCLUDED
...
/** A special account that's used as the "issuer" for SUN. */
AccountID const&
sunAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, sunnycoind should
...
public:
    ...
    /** Return sunnycoin::toBase58 for the AccountID
...
template <>
struct hash <sunnycoin::AccountID> : sunnycoin::AccountID::hasher
{
