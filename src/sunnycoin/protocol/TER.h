...
/*
    ...
    Copyright (c) 2012 - 2018 SUNNYCoin Labs Inc.
...
#ifndef SUNNYCOIN_PROTOCOL_TER_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_TER_H_INCLUDED
...
// See https://sunnycoin.com/wiki/Transaction_errors
//
...
enum TEMcodes : TERUnderlyingType
{
    ...
    temBAD_PATH,
    temBAD_PATH_LOOP,
    temBAD_SEND_SUN_LIMIT,
    temBAD_SEND_SUN_MAX,
    temBAD_SEND_SUN_NO_DIRECT,
    temBAD_SEND_SUN_PARTIAL,
    temBAD_SEND_SUN_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
...
enum TERcodes : TERUnderlyingType
{
    ...
    terNO_SUNNYCOIN,        // Rippling not allowed
...
enum TECcodes : TERUnderlyingType
{
    ...
    // 100 .. 159 C
    //   Claim fee only (sunnycoin transaction with no good paths, pay to
