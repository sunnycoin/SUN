...
#ifndef SUNNYCOIN_PROTOCOL_DIGEST_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_DIGEST_H_INCLUDED

#include <sunnycoin/basics/base_uint.h>
#include <sunnycoin/beast/crypto/ripemd.h>
#include <sunnycoin/beast/crypto/sha2.h>
#include <sunnycoin/beast/hash/endian.h>
#include <algorithm>
#include <array>

namespace sunnycoin {

/*  Message digest functions used in the SUNNYCoin Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a SUNNYCoin account, from a message. Typically the
