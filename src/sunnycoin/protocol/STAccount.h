...
#ifndef SUNNYCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a sunnycoin::uint160.  However, so the serialized format of the
