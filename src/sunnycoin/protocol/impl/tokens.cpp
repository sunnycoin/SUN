...
{
    return encodeToken(type, token, size, sunnycoinAlphabet);
}
...
/*  Base58 decode a SUNNYCoin token
...
static InverseAlphabet sunnycoinInverse(sunnycoinAlphabet);
...
{
    return decodeBase58Token(s, type, sunnycoinInverse);
}
