...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send SUN to create it."                            } },
        { tecNO_DST_INSUF_SUN,       { "tecNO_DST_INSUF_SUN",      "Destination does not exist. Too little SUN sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient SUN balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient SUN balance to send."                                             } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not SUN."                                             } },
        ...
        { temBAD_SEND_SUN_LIMIT,     { "temBAD_SEND_SUN_LIMIT",    "Malformed: Limit quality is not allowed for SUN to SUN."                       } },
        { temBAD_SEND_SUN_MAX,       { "temBAD_SEND_SUN_MAX",      "Malformed: Send max is not allowed for SUN to SUN."                            } },
        { temBAD_SEND_SUN_NO_DIRECT, { "temBAD_SEND_SUN_NO_DIRECT","Malformed: No SUNNYCoin direct is not allowed for SUN to SUN."                    } },
        { temBAD_SEND_SUN_PARTIAL,   { "temBAD_SEND_SUN_PARTIAL",  "Malformed: Partial payment is not allowed for SUN to SUN."                     } },
        { temBAD_SEND_SUN_PATHS,     { "temBAD_SEND_SUN_PATHS",    "Malformed: Paths are not allowed for SUN to SUN."                              } },
        ...
        { temSUNNYCOIN_EMPTY,           { "temSUNNYCOIN_EMPTY",          "PathSet with no paths."                                                        } },
        ...
        { terNO_SUNNYCOIN,              { "terNO_SUNNYCOIN",             "Path does not permit rippling."                                                } },
