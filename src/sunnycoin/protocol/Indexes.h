...
#ifndef SUNNYCOIN_PROTOCOL_INDEXES_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_INDEXES_H_INCLUDED

#include <sunnycoin/protocol/Keylet.h>
...
uint256
getSUNNYCoinStateIndex (AccountID const& a, AccountID const& b, Currency const& currency);

uint256
getSUNNYCoinStateIndex (AccountID const& a, Issue const& issue);
