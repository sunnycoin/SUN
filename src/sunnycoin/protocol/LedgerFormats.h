...
#ifndef SUNNYCOIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <sunnycoin/protocol/KnownFormats.h>
...
enum LedgerEntryType
{
    ...
    */
    ...
    // Simple unidirection sun channel
    ltPAYCHAN           = 'x',
...
enum LedgerSpecificFlags
{
    ...
    lsfDisallowSUN      = 0x00080000,   // True, to disallow sending SUN.
    lsfDisableMaster    = 0x00100000,   // True, force regular key
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze sunnycoin states
    lsfGlobalFreeze     = 0x00400000,   // True, all assets frozen
    lsfDefaultSUNNYCoin    = 0x00800000,   // True, trust lines allow rippling by default
    ...
    lsfLowNoSUNNYCoin      = 0x00100000,
    lsfHighNoSUNNYCoin     = 0x00200000,
