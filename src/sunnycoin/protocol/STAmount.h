...
#ifndef SUNNYCOIN_PROTOCOL_STAMOUNT_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_STAMOUNT_H_INCLUDED

#include <sunnycoin/basics/chrono.h>
#include <sunnycoin/basics/LocalValue.h>
#include <sunnycoin/protocol/SField.h>
#include <sunnycoin/protocol/Serializer.h>
#include <sunnycoin/protocol/STBase.h>
...
private:
    ...
    bool mIsNative;      // A shorthand for isSUN(mIssue).
    bool mIsNegative;
...
public:
    ...
    STAmount (SUNAmount const& amount);
...
public:
    ...
    STAmount& operator= (SUNAmount const& amount)
    {
...
// IOUAmount and SUNAmount define toSTAmount, defining this
...
inline bool isSUN(STAmount const& amount)
{
    return isSUN (amount.issue().currency);
}
