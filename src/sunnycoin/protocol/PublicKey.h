...
#ifndef SUNNYCOIN_PROTOCOL_PUBLICKEY_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_PUBLICKEY_H_INCLUDED

#include <sunnycoin/basics/Slice.h>
#include <sunnycoin/crypto/KeyType.h> // move to protocol/
#include <sunnycoin/protocol/STExchange.h>
...
/** A public key.
    ...
    The format of the public key is SUNNYCoin specific,
