...
#ifndef SUNNYCOIN_PROTOCOL_JSONFIELDS_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( alternatives );               // out: PathRequest, SUNNYCoinPathFind
...
JSS ( base_fee_sun );               // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, SUNNYCoinPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, SUNNYCoinPathFind
JSS ( destination_currencies );     // in: PathRequest, SUNNYCoinPathFind
...
JSS ( issuer );                     // in: SUNNYCoinPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: RPCHelpers, LedgerRequest,
                                    //     SUNNYCoinPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_sunnycoin );                  // out: AccountLines
JSS ( no_sunnycoin_peer );             // out: AccountLines
...
JSS ( paths );                      // in: SUNNYCoinPathFind
JSS ( paths_canonical );            // out: SUNNYCoinPathFind
JSS ( paths_computed );             // out: PathRequest, SUNNYCoinPathFind
...
JSS ( reserve_base_sun );           // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_sun );            // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( sunnycoin_lines );               // out: NetworkOPs
JSS ( sunnycoin_state );               // in: LedgerEntr
JSS ( sunnycoinrpc );                  // sunnycoin RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rpc );
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( running_duration_us );
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: SUNNYCoinPathFind
...
JSS ( send_max );                   // in: PathRequest, SUNNYCoinPathFind
...
JSS ( source_account );             // in: PathRequest, SUNNYCoinPathFind
JSS ( source_amount );              // in: PathRequest, SUNNYCoinPathFind
JSS ( source_currencies );          // in: PathRequest, SUNNYCoinPathFind
