...
#ifndef SUNNYCOIN_PROTOCOL_TOKENS_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_TOKENS_H_INCLUDED
...
// Facilities for converting SUNNYCoin tokens
// to and from their human readable strings

/*  Base-58 encode a SUNNYCoin Token

    SUNNYCoin Tokens have a one-byte prefx indicating
