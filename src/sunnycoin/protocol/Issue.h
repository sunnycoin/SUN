...
#ifndef SUNNYCOIN_PROTOCOL_ISSUE_H_INCLUDED
#define SUNNYCOIN_PROTOCOL_ISSUE_H_INCLUDED
...
/** Returns an asset specifier that represents SUN. */
inline Issue const& sunIssue ()
{
    static Issue issue {sunCurrency(), sunAccount()};
    return issue;
}
