...
The SUNNYCoin payment protocol enforces a fee schedule expressed in units of the
native currency, SUN. Fees for transactions are paid directly from the account
...
may want to change fees is when the value of the native currency SUN fluctuates
...
The SUNNYCoin consensus algorithm allows distributed participants to arrive at
...
A validating instance of sunnycoind uses information in the configuration file
...
consensus to succeed, otherwise different instances of sunnycoind will get
...
*  A pull request is created and the new code is folded into a sunnycoind build
