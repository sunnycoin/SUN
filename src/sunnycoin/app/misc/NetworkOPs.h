...
#ifndef SUNNYCOIN_APP_MISC_NETWORKOPS_H_INCLUDED
#define SUNNYCOIN_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    sunnycoind / NetworkOPs. However, client software connecting to non-local
    instances of sunnycoind will need to be hardened to protect against hostile
