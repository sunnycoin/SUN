...
#ifndef SUNNYCOIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define SUNNYCOIN_APP_MISC_VALIDATORLIST_H_INCLUDED

#include <sunnycoin/app/misc/Manifest.h>
...
/**
    ...
    SUNNYCoind accepts ledger proposals and validations from trusted validator
    ...
    This class manages the set of validation public keys the local sunnycoind node
    ...
    @li @c "blob": Base64-encoded JSON string containing a @c "sequence", @c
        ...
        SUNNYCoin timestamp (seconds since January 1st, 2000 (00:00 UTC)) for when
