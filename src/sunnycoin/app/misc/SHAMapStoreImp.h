...
#ifndef SUNNYCOIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define SUNNYCOIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED

#include <sunnycoin/app/misc/SHAMapStore.h>
#include <sunnycoin/app/ledger/LedgerMaster.h>
#include <sunnycoin/core/DatabaseCon.h>
#include <sunnycoin/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "sunnycoindb";
...
private:
    ...
    // If sunnycoind is not healthy, defer rotate-delete.
