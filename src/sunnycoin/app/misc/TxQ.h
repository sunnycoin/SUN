...
/*
    ...
    Copyright (c) 2012-14 SUNNYCoin Labs Inc.
...
#ifndef SUNNYCOIN_TXQ_H_INCLUDED
#define SUNNYCOIN_TXQ_H_INCLUDED
...
private:
    ...
    public:
        ...
        /**
            ...
            @param timeLeap Indicates that sunnycoind is under load so fees
            should grow faster.
        */
        std::size_t
