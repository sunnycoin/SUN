...
#ifndef SUNNYCOIN_APP_MISC_DETAIL_WORKSSL_H_INCLUDED
#define SUNNYCOIN_APP_MISC_DETAIL_WORKSSL_H_INCLUDED

#include <sunnycoin/app/misc/detail/WorkBase.h>
#include <sunnycoin/net/RegisterSSLCerts.h>
