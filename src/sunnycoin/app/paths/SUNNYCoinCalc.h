...
#ifndef SUNNYCOIN_APP_PATHS_SUNNYCOINCALC_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_SUNNYCOINCALC_H_INCLUDED
...
/** SUNNYCoinCalc calculates the quality of a payment path.
...
private:
    ...
    TER sunnycoinCalculate (detail::FlowDebugInfo* flowDebugInfo=nullptr);
