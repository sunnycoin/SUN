...
#ifndef SUNNYCOIN_APP_PATHS_SUNNYCOINLINECACHE_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_SUNNYCOINLINECACHE_H_INCLUDED

#include <sunnycoin/app/ledger/Ledger.h>
#include <sunnycoin/app/paths/SUNNYCoinState.h>
#include <sunnycoin/basics/hardened_hash.h>
#include <cstddef>
#include <memory>
#include <mutex>
#include <vector>
...
public:
    ...
    std::vector<SUNNYCoinState::pointer> const&
    getSUNNYCoinLines (AccountID const& accountID);

private:
    std::mutex mLock;

    sunnycoin::hardened_hash<> hasher_;
