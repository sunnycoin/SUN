...
#ifndef SUNNYCOIN_APP_PATHS_ACCOUNTCURRENCIES_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_ACCOUNTCURRENCIES_H_INCLUDED
...
accountSourceCurrencies(
    AccountID const& account,
        std::shared_ptr<SUNNYCoinLineCache> const& lrLedger,
             bool includeSUN);
