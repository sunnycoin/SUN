...
#ifndef SUNNYCOIN_APP_PATHS_PATHREQUEST_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_PATHREQUEST_H_INCLUDED
...
public:
    ...
    std::pair<bool, Json::Value> doCreate (
        std::shared_ptr<SUNNYCoinLineCache> const&,
        Json::Value const&);
    ...
    // update jvStatus
    Json::Value doUpdate (
        std::shared_ptr<SUNNYCoinLineCache> const&, bool fast);
...
private:
    ...
    bool isValid (std::shared_ptr<SUNNYCoinLineCache> const& crCache);
    void setValid ();

    std::unique_ptr<Pathfinder> const&
    getPathFinder(std::shared_ptr<SUNNYCoinLineCache> const&,
    ...
    */
    bool
    findPaths (std::shared_ptr<SUNNYCoinLineCache> const&, int const, Json::Value&);
