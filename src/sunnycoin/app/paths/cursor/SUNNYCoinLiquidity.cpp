...
void sunnycoinLiquidity (
    SUNNYCoinCalc& sunnycoinCalc,
    ...
    std::uint64_t& uRateMax)
{
    ...
    if (qualityIn >= qualityOut)
    {
        ...
        JLOG (sunnycoinCalc.j_.trace()) << "sunnycoinLiquidity: No fees";
    ...
    else
    {
        ...
        JLOG (sunnycoinCalc.j_.trace()) << "sunnycoinLiquidity: Fee";
        ...
        if (!uRateMax || uRate <= uRateMax)
        {
            ...
            else
            {
                ...
                JLOG (sunnycoinCalc.j_.trace())
                    << "sunnycoinLiquidity:4: saCurReq=" << saCurReq;
...
quality_in (
    ...
    Currency const& currency)
{
    return sunnycoinQuality (view, uToAccountID, uFromAccountID, currency,
