...
#ifndef SUNNYCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
private:
    ...
    {
        return {sunnycoinCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
