...
//
// Currency cannot be SUN because we are rippling.
//
...
TER PathCursor::reverseLiquidityForAccount () const
{
    ...
    // page section: https://sunnycoin.com/wiki/Transit_Fees#Implementation
    ...
    else if (!previousNodeIsAccount && nextNodeIsAccount)
    {
        ...
        else
        {
            ...
            // deliver -> redeem
            // TODO(tom): now we have more checking in nodeSUNNYCoin, these checks
            // might be redundant.
