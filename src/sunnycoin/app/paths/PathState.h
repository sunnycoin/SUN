...
#ifndef SUNNYCOIN_APP_PATHS_PATHSTATE_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_PATHSTATE_H_INCLUDED
...
class PathState : public CountedObject <PathState>
{
  public:
    ...
    TER checkNoSUNNYCoin (AccountID const& destinationAccountID,
