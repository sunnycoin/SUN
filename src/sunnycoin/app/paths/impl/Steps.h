...
#ifndef SUNNYCOIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/SUN offer book
     BookStepXI is an SUN/IOU offer book
     SUNEndpointStep is the source or destination account for SUN
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoSUNNYCoin.
    */
    ...
    // For SUN endpoints, one of src or dst will be the root account
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no sunnycoin
        constraint
     */
