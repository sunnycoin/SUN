...
#ifndef SUNNYCOIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
#define SUNNYCOIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
...
/**
   ...
   @param strand Steps of Accounts to sunnycoin through and offer books to use
    ...
    beast::Journal j)
{
    ...
    {
        // The current implementation returns NO_LINE for SUN->SUN transfers.
        // Keep this behavior
...
/**
   ...
   @param baseView Trust lines and balances
   @param strands Each strand contains the steps of accounts to sunnycoin through
