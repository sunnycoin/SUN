...
#ifndef SUNNYCOIN_TX_APPLYCONTEXT_H_INCLUDED
#define SUNNYCOIN_TX_APPLYCONTEXT_H_INCLUDED
...
public:
     ...
     */
    TER
    checkInvariants(TER const result, SUNAmount const fee);
...
private:
    ...
    TER
    checkInvariantsHelper(TER const result, SUNAmount const fee, std::index_sequence<Is...>);
