...
#ifndef SUNNYCOIN_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED
#define SUNNYCOIN_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED

#include <sunnycoin/app/tx/impl/Transactor.h>    // NotTEC
#include <sunnycoin/protocol/STTx.h>             // STTx::maxMultiSigners
#include <sunnycoin/protocol/UintTypes.h>        // AccountID
#include <sunnycoin/protocol/TER.h>              // temMALFORMED
#include <sunnycoin/beast/utility/Journal.h>     // beast::Journal
...
#endif // SUNNYCOIN_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED
