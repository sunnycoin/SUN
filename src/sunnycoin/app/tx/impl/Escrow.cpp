...
#include <sunnycoin/app/tx/impl/Escrow.h>

#include <sunnycoin/app/misc/HashRouter.h>
#include <sunnycoin/basics/chrono.h>
#include <sunnycoin/basics/Log.h>
#include <sunnycoin/conditions/Condition.h>
#include <sunnycoin/conditions/Fulfillment.h>
...
/*
    ...
    Escrow is a feature of the SUN Ledger that allows you to send conditional
    SUN payments. These conditional payments, called escrows, set aside SUN and
    ...
    The SUN set aside in an escrow is locked up. No one can use or destroy the
    SUN until the escrow has been successfully finished or canceled. Before the
    expiration time, only the intended receiver can get the SUN. After the
    expiration time, the SUN can only be returned to the sender.

    For more details on escrow, including examples, diagrams and more please
    visit https://sunnycoin.com/build/escrow/#escrow
    ...
    `EscrowCreate`
    --------------
        See: https://sunnycoin.com/build/transactions/#escrowcreate

    `EscrowFinish`
    --------------
        See: https://sunnycoin.com/build/transactions/#escrowfinish

    `EscrowCancel`
    --------------
        See: https://sunnycoin.com/build/transactions/#escrowcancel
*/
...
EscrowCreate::preflight (PreflightContext const& ctx)
{
    ...
    {
        using namespace sunnycoin::cryptoconditions;
...
EscrowCreate::doApply()
{
    ...
    {
        auto const balance = STAmount((*sle)[sfBalance]).sun();
        ...
        if (balance < reserve + STAmount(ctx_.tx[sfAmount]).sun())
            return tecUNFUNDED;
    }
    ...
    // Check destination account
    {
        ...
        // Obeying the lsfDissalowSUN flag was a bug.  Piggyback on
