...
#ifndef SUNNYCOIN_APP_TX_TRANSACTOR_H_INCLUDED
#define SUNNYCOIN_APP_TX_TRANSACTOR_H_INCLUDED
...
protected:
    ...
    AccountID     account_;
    SUNAmount     mPriorBalance;  // Balance before fees.
    SUNAmount     mSourceBalance; // Balance after fees.
...
protected:
    ...
    /** Compute the minimum fee required to process a transaction
        ...
        @param baseFee The base fee of a candidate transaction
            @see sunnycoin::calculateBaseFee
