...
#ifndef SUNNYCOIN_APP_BOOK_OFFER_H_INCLUDED
#define SUNNYCOIN_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, SUNAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<SUNAmount, IOUAmount>::setFieldAmounts ()
{
