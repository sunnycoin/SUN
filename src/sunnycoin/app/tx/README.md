...
In order to enhance the flexibility of SUNNYCoin and provide support for enhanced
...
Some technical details, including tables indicating some of the SUNNYCoin
commands and ledger entries to be used for implementing multi-signature, are
currently listed on the [wiki](https://sunnycoin.com/wiki/Multisign) but will
...
transaction is to be signed outside the SUNNYCoin network and only submitted
...
some messaging mechanism outside the SUNNYCoin network to disseminate the proposed
...
out and discussed on the [wiki](https://sunnycoin.com/wiki/Multisign). This
...
Currently transactions on the SUNNYCoin network require the use of sequence
