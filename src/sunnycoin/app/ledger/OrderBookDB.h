...
#ifndef SUNNYCOIN_APP_LEDGER_ORDERBOOKDB_H_INCLUDED
#define SUNNYCOIN_APP_LEDGER_ORDERBOOKDB_H_INCLUDED

#include <sunnycoin/app/ledger/AcceptedLedgerTx.h>
#include <sunnycoin/app/ledger/BookListeners.h>
#include <sunnycoin/app/main/Application.h>
#include <sunnycoin/app/misc/OrderBook.h>
#include <mutex>
...
private:
    ...
    // does an order book to SUN exist
    hash_set <Issue> mSUNBooks;
