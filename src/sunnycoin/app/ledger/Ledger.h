...
#ifndef SUNNYCOIN_APP_LEDGER_LEDGER_H_INCLUDED
#define SUNNYCOIN_APP_LEDGER_LEDGER_H_INCLUDED

#include <sunnycoin/ledger/TxMeta.h>
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an SUN balance equal to the total amount
        of SUN in the system. No more SUN than the amount which
    ...
    */
    ...
    void
    rawDestroySUN (SUNAmount const& fee) override
    {
        info_.drops -= fee;
    }
