...
#ifndef SUNNYCOIN_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED
#define SUNNYCOIN_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED

#include <sunnycoin/app/ledger/Ledger.h>
#include <sunnycoin/basics/ScopedLock.h>
#include <sunnycoin/consensus/Validations.h>
...
public:
    using NodeKey = sunnycoin::PublicKey;
    using NodeID = sunnycoin::NodeID;
