...
#ifndef SUNNYCOIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define SUNNYCOIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return sunnycoin::getCloseAgree(ledger_->info());
    }
    ...
    getJson() const
    {
        return sunnycoin::getJson(*ledger_);
    }
