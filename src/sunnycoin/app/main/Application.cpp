...
#include <sunnycoin/app/main/DBInit.h>
#include <sunnycoin/app/main/BasicApp.h>
#include <sunnycoin/app/main/Tuning.h>
...
#include <sunnycoin/app/ledger/PendingSaves.h>
#include <sunnycoin/app/ledger/InboundTransactions.h>
#include <sunnycoin/app/ledger/TransactionMaster.h>
#include <sunnycoin/app/main/LoadManager.h>
#include <sunnycoin/app/main/NodeIdentity.h>
#include <sunnycoin/app/main/NodeStoreScheduler.h>
#include <sunnycoin/app/misc/AmendmentTable.h>
#include <sunnycoin/app/misc/HashRouter.h>
#include <sunnycoin/app/misc/LoadFeeTrack.h>
#include <sunnycoin/app/misc/NetworkOPs.h>
#include <sunnycoin/app/misc/SHAMapStore.h>
...
#include <sunnycoin/basics/ResolverAsio.h>
#include <sunnycoin/basics/Sustain.h>
#include <sunnycoin/basics/PerfLog.h>
#include <sunnycoin/json/json_reader.h>
#include <sunnycoin/nodestore/DummyScheduler.h>
#include <sunnycoin/overlay/Cluster.h>
#include <sunnycoin/overlay/make_Overlay.h>
...
#include <sunnycoin/beast/asio/io_latency_probe.h>
...
public:
    ...
    {
    #if SUNNYCOIN_SINGLE_IO_SERVICE_THREAD
        return 1;
    #else
            ...
            if (freeSpace < bytes512M)
            {
                JLOG(m_journal.fatal())
                    << "Free SQLite space for transaction db is less than "
                       "512MB. To fix this, sunnycoind must be executed with the "
