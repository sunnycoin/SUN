...
#include <sunnycoin/core/TerminateHandler.h>
#include <sunnycoin/core/TimeKeeper.h>
#include <sunnycoin/crypto/csprng.h>
#include <sunnycoin/json/to_string.h>
#include <sunnycoin/net/RPCCall.h>
#include <sunnycoin/resource/Fees.h>
#include <sunnycoin/rpc/RPCHandler.h>
#include <sunnycoin/protocol/BuildInfo.h>
#include <sunnycoin/beast/clock/basic_seconds_clock.h>
#include <sunnycoin/beast/core/CurrentThreadName.h>
#include <sunnycoin/beast/utility/Debug.h>
...
void printHelp (const po::options_description& desc)
{
    std::cerr
        ...
        << "Commands: \n"
           ...
           "     random\n"
           "     sunnycoin ...\n"
           "     sunnycoin_path_find <json> [<ledger>]\n"
           "     version\n"
    ...
    char** argv)
{
    ...
    using namespace sunnycoin::test;

    sunnycoin::test::envUseIPv4 = (! ipv6);
...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("sunnycoind: main");
    ...
    {
        std::cerr << "sunnycoind: Incorrect command line syntax." << std::endl;
    ...
    else
    {
        if (vm.count("unittest-jobs"))
        {
            ...
            std::cerr << "sunnycoind: '--unittest-jobs' specified without '--unittest'.\n";
    ...
    beast::setCurrentThreadName ("sunnycoind: rpc");
...
int main (int argc, char** argv)
{
    ...
    sunnycoin::sha512_deprecatedMSVCWorkaround();
#endif
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile sunnycoind.");
#endif
    ...
    //
#if SUNNYCOIN_DUMP_LEAKS_ON_EXIT
    ...
    std::set_terminate(sunnycoin::terminateHandler);

    auto const result (sunnycoin::run (argc, argv));
