...
#ifndef SUNNYCOIN_BASICS_HARDENED_HASH_H_INCLUDED
#define SUNNYCOIN_BASICS_HARDENED_HASH_H_INCLUDED

#include <sunnycoin/beast/hash/hash_append.h>
#include <sunnycoin/beast/hash/xxhasher.h>
...
//
#ifndef SUNNYCOIN_NO_HARDENED_HASH_INSTANCE_SEED
# ifdef __GLIBCXX__
#  define SUNNYCOIN_NO_HARDENED_HASH_INSTANCE_SEED 1
# else
#  define SUNNYCOIN_NO_HARDENED_HASH_INSTANCE_SEED 0
# endif
#endif
...
*/
#if SUNNYCOIN_NO_HARDENED_HASH_INSTANCE_SEED
