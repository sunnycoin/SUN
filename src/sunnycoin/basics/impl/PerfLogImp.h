...
/*
    ...
    Copyright (c) 2018 SUNNYCoin Labs Inc.
...
#ifndef SUNNYCOIN_BASICS_PERFLOGIMP_H
#define SUNNYCOIN_BASICS_PERFLOGIMP_H
...
#include <sunnycoin/rpc/impl/Handler.h>
    ...
    : public PerfLog, Stoppable
{
    ...
    Counters counters_ {sunnycoin::RPC::getHandlerNames(), JobTypes::instance()};
...
#endif //SUNNYCOIN_BASICS_PERFLOGIMP_H
