...
// On sunnycoind shutdown, cancel and wait for the update thread
...
// This actually measures time since first use, instead of since sunnycoind start.
...
UptimeClock::now()
{
    ...
    // Return the number of seconds since sunnycoind start
