...
#ifndef SUNNYCOIN_BASICS_RANGESET_H_INCLUDED
#define SUNNYCOIN_BASICS_RANGESET_H_INCLUDED
...
void
save(Archive& ar,
    sunnycoin::ClosedInterval<T> const& ci,
...
template <class Archive, class T>
void
load(Archive& ar, sunnycoin::ClosedInterval<T>& ci, const unsigned int version)
{
    T low, up;
    ar >> low >> up;
    ci = sunnycoin::ClosedInterval<T>{low, up};
}

template <class Archive, class T>
void
serialize(Archive& ar,
    sunnycoin::ClosedInterval<T>& ci,
    const unsigned int version)
{
...
template <class Archive, class T>
void
save(Archive& ar, sunnycoin::RangeSet<T> const& rs, const unsigned int version)
{
...
template <class Archive, class T>
void
load(Archive& ar, sunnycoin::RangeSet<T>& rs, const unsigned int version)
{
    rs.clear();
...
template <class Archive, class T>
void
serialize(Archive& ar, sunnycoin::RangeSet<T>& rs, const unsigned int version)
{
