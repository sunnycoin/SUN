...
#ifndef SUNNYCOIN_BASICS_UPTIMETIMER_H_INCLUDED
#define SUNNYCOIN_BASICS_UPTIMETIMER_H_INCLUDED
...
public:
    ...
    static time_point now();  // seconds since sunnycoind program start
