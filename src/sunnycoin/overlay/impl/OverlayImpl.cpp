...
#include <sunnycoin/overlay/impl/ConnectAttempt.h>
#include <sunnycoin/overlay/impl/PeerImp.h>
#include <sunnycoin/peerfinder/make_Manager.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("54.249.44.34:51235");
    ...
    // Add the ips_fixed from the sunnycoind.cfg file
...
/** The number of active peers on the network
    ...
    and are running the SUNNYCoin protocol.
*/
std::size_t
OverlayImpl::size()
{
