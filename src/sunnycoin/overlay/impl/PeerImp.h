...
#ifndef SUNNYCOIN_OVERLAY_PEERIMP_H_INCLUDED
#define SUNNYCOIN_OVERLAY_PEERIMP_H_INCLUDED

#include <sunnycoin/app/consensus/RCLCxPeerPos.h>
#include <sunnycoin/basics/Log.h>
#include <sunnycoin/beast/utility/WrappedSink.h>
#include <sunnycoin/basics/RangeSet.h>
#include <sunnycoin/overlay/impl/ProtocolMessage.h>
#include <sunnycoin/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the SUNNYCoin protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of sunnycoind that the peer is running, if reported. */
    std::string
    getVersion() const;
