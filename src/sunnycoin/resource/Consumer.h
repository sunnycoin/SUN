...
#ifndef SUNNYCOIN_RESOURCE_CONSUMER_H_INCLUDED
#define SUNNYCOIN_RESOURCE_CONSUMER_H_INCLUDED

#include <sunnycoin/resource/Charge.h>
#include <sunnycoin/resource/Disposition.h>
