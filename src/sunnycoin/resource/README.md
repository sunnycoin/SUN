...
additional SUN for transactions, requiring a proof of work to be
...
overlay network implementing the SUNNYCoin protocol.
...
In sunnycoind, the Application holds a unique instance of Resource::Manager,
