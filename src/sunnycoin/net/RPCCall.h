...
#ifndef SUNNYCOIN_NET_RPCCALL_H_INCLUDED
#define SUNNYCOIN_NET_RPCCALL_H_INCLUDED
...
/** Given a sunnycoind command line, return the corresponding JSON.
*/
Json::Value
