...
#ifndef SUNNYCOIN_JSON_WRITER_H_INCLUDED
#define SUNNYCOIN_JSON_WRITER_H_INCLUDED

#include <sunnycoin/basics/contract.h>
#include <sunnycoin/basics/ToString.h>
...
{
    if (! condition)
        sunnycoin::Throw<std::logic_error> (message);
}
