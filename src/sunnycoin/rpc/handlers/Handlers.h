...
#ifndef SUNNYCOIN_RPC_HANDLERS_HANDLERS_H_INCLUDED
#define SUNNYCOIN_RPC_HANDLERS_HANDLERS_H_INCLUDED

#include <sunnycoin/rpc/handlers/LedgerHandler.h>
...
Json::Value doNoSUNNYCoinCheck         (RPC::Context&);
...
Json::Value doSUNNYCoinPathFind        (RPC::Context&);
