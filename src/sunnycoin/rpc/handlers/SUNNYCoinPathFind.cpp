...
Json::Value doSUNNYCoinPathFind (RPC::Context& context)
{
        ...
        ! context.params.isMember(jss::ledger_hash))
    {
        ...
        //
        // 1. We're running doSUNNYCoinPathFind() due to a call to
        //    sunnycoin_path_find.  doSUNNYCoinPathFind() is currently running
        //    inside of a JobQueue::Coro using a JobQueue thread.
        //
        // 2. doSUNNYCoinPathFind's call to makeLegacyPathRequest() enqueues the
        ...
        // sunnycoind source code) shutting down the application.  The code to
