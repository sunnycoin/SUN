...
For this purpose, the sunnycoind RPC handler allows *suspension with continuation*
...
Suspension with continuation uses four `std::function`s in the `sunnycoin::RPC`
namespace:
