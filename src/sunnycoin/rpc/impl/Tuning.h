...
#ifndef SUNNYCOIN_RPC_TUNING_H_INCLUDED
#define SUNNYCOIN_RPC_TUNING_H_INCLUDED
...
/** Limits for the no_sunnycoin_check command. */
static LimitRange const noSUNNYCoinCheck = {10, 300, 400};
