...
#include <sunnycoin/rpc/handlers/Version.h>
...
Handler const handlerArray[] {
    ...
    {   "nosunnycoin_check",       byRef (&doNoSUNNYCoinCheck),       Role::USER,  NO_CONDITION  },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "sunnycoin_path_find",     byRef (&doSUNNYCoinPathFind),      Role::USER,  NO_CONDITION  },
