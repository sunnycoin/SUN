...
#ifndef SUNNYCOIN_LEDGER_READVIEW_H_INCLUDED
#define SUNNYCOIN_LEDGER_READVIEW_H_INCLUDED

#include <sunnycoin/ledger/detail/ReadViewFwdRange.h>
...
#include <sunnycoin/ledger/detail/ReadViewFwdRange.ipp>
