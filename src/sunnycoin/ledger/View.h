...
#ifndef SUNNYCOIN_LEDGER_VIEW_H_INCLUDED
#define SUNNYCOIN_LEDGER_VIEW_H_INCLUDED

#include <sunnycoin/ledger/ApplyView.h>
#include <sunnycoin/ledger/OpenView.h>
#include <sunnycoin/ledger/RawView.h>
...
// Return the account's liquid (not reserved) SUN.  Generally prefer
