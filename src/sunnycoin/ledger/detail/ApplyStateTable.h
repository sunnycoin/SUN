...
#ifndef SUNNYCOIN_LEDGER_APPLYSTATETABLE_H_INCLUDED
#define SUNNYCOIN_LEDGER_APPLYSTATETABLE_H_INCLUDED
...
public:
    ...
    void
    destroySUN (SUNAmount const& fee);

    // For debugging
    SUNAmount const& dropsDestroyed () const
    {
