...
#ifndef SUNNYCOIN_LEDGER_PAYMENTSANDBOX_H_INCLUDED
#define SUNNYCOIN_LEDGER_PAYMENTSANDBOX_H_INCLUDED

#include <sunnycoin/ledger/RawView.h>
#include <sunnycoin/ledger/Sandbox.h>
#include <sunnycoin/ledger/detail/ApplyViewBase.h>
