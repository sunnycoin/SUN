...
#ifndef SUNNYCOIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define SUNNYCOIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to sunnycoin/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
