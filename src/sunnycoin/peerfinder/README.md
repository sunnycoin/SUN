...
The _SUNNYCoin payment network_ consists of a collection of _peers_ running the
**sunnycoind software**. Each peer maintains multiple outgoing connections and
...
**sunnycoind** is launched, the existing Bootcache database data is accessed and
...
outgoing connections to foreign peers. This security feature helps sunnycoind
