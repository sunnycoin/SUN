...
#ifndef SUNNYCOIN_PEERFINDER_SLOTIMP_H_INCLUDED
#define SUNNYCOIN_PEERFINDER_SLOTIMP_H_INCLUDED

#include <sunnycoin/peerfinder/Slot.h>
#include <sunnycoin/peerfinder/PeerfinderManager.h>
#include <sunnycoin/beast/core/CompilerConfig.h>
