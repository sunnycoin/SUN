...
#ifndef SUNNYCOIN_PEERFINDER_LIVECACHE_H_INCLUDED
#define SUNNYCOIN_PEERFINDER_LIVECACHE_H_INCLUDED
...
#include <sunnycoin/peerfinder/impl/Tuning.h>
#include <sunnycoin/beast/container/aged_map.h>
#include <sunnycoin/beast/utility/maybe_const.h>
