...
CMAKE_UNITY_COMBOS = { '' : [['sunnycoind'], CMAKE_UNITY_CONFIGS],
    '.nounity' : [['sunnycoind'], CMAKE_NONUNITY_CONFIGS] }
...
parser = argparse.ArgumentParser(
    description='Test.py - run sunnycoin tests'
)
